...
class newskategoriolahraga extends StatefulWidget {
  const newskategoriolahraga({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<newskategoriolahraga> createState() => _newskategoriolahraga();
}

class _newskategoriolahraga extends State<newskategoriolahraga> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder<List<news>?>(
          future:ApiServices().getnewscat("Olahraga"),
