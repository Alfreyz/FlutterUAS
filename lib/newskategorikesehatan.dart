...
class newskategorikesehatan extends StatefulWidget {
  const newskategorikesehatan({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<newskategorikesehatan> createState() => _newskategorikesehatan();
}

class _newskategorikesehatan extends State<newskategorikesehatan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: FutureBuilder<List<news>?>(
          future:ApiServices().getnewscat("Kesehatan"),
